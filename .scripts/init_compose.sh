...
psql -h 170.64.135.239 -p 5432 -d postgres -U postgres -f "$DEPLOY_BASE_PATH/Resources/SQL/drop_avaprod_db.sql"
psql -h 170.64.135.239 -p 5432 -d postgres -U postgres -f "$DEPLOY_BASE_PATH/Resources/SQL/create_avaprod_db.sql"
...
psql -h 170.64.135.239 -p 5432 -d avaprod -U postgres -f "$DEPLOY_BASE_PATH/Resources/SQL/import_airports_merged.sql"
