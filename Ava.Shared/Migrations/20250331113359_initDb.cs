        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppId = table.Column<string>(type: "varchar(20)", nullable: false),
                    SupportedEmailDomains = table.Column<string>(type: "text", nullable: false),
                    Signature = table.Column<string>(type: "text", nullable: false),
                    SpendThreshold = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CliendID = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ...
                    BillingPersonFirstName = table.Column<string>(type: "text", nullable: false),
                    BillingPersonLastName = table.Column<string>(type: "text", nullable: false),
                    BillingPersonPhone = table.Column<string>(type: "text", nullable: false),
                    BillingPersonEmail = table.Column<string>(type: "text", nullable: false),
                    BillingPersonJobTitle = table.Column<string>(type: "text", nullable: true),
                    AdminPersonFirstName = table.Column<string>(type: "text", nullable: false),
                    AdminPersonLastName = table.Column<string>(type: "text", nullable: false),
                    AdminPersonPhone = table.Column<string>(type: "text", nullable: false),
                    AdminPersonEmail = table.Column<string>(type: "text", nullable: false),
                    ...
                    DefaultTravelPolicyId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SupportedEmailDomain = table.Column<string>(type: "varchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TravelPolicyId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
